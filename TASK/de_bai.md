...
- Các file .txt là các văn bản dạng free-form text làm input của bài toán. Lưu ý: các văn bản free-form text đều chứa nhiều hơn 1 khái niệm.
